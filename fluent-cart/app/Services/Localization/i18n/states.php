...
return array(
    ...
    'AR' => array( // Argentinian provinces.
        ...
        'X' => _x('Córdoba', 'Argentina Province', 'fluent-cart'),
        ...
        'F' => _x('La Rioja', 'Argentina Province', 'fluent-cart'),
        'M' => __('Mendoza', 'fluent-cart'),
        'N' => _x('Misiones', 'Argentina Province', 'fluent-cart'),
        'Q' => __('Neuquén', 'fluent-cart'),
        'R' => _x('Río Negro', 'Argentina Province', 'fluent-cart'),
        'A' => __('Salta', 'fluent-cart'),
        'J' => _x('San Juan', 'Argentina Province', 'fluent-cart'),
        'D' => __('San Luis', 'fluent-cart'),
        'Z' => _x('Santa Cruz', 'Argentina Province', 'fluent-cart'),
    ...
    'BG' => array( // Bulgarian states.
        ...
        'BG-12' => _x('Montana', 'Bulgaria Province', 'fluent-cart'),
    ...
    'BJ' => array( // Beninese states.
        ...
        'PL' => _x('Plateau', 'Benin Department', 'fluent-cart'),
    ...
    'BO' => array( // Bolivian states.
        ...
        'BO-L' => _x('La Paz', 'Bolivia Department', 'fluent-cart'),
        'BO-O' => __('Oruro', 'fluent-cart'),
        'BO-N' => __('Pando', 'fluent-cart'),
        'BO-P' => __('Potosí', 'fluent-cart'),
        'BO-S' => _x('Santa Cruz', 'Bolivia Department', 'fluent-cart'),
    ...
    'BR' => array( // Brazilian states.
        ...
        'AM' => _x('Amazonas', 'Brazil State', 'fluent-cart'),
    ...
    'CL' => array( // Chilean states.
        ...
        'CL-LR' => _x('Los Ríos', 'Chile Region', 'fluent-cart'),
    ...
    'CO' => array( // Colombian states.
        'CO-AMA' => _x('Amazonas', 'Colombia Department', 'fluent-cart'),
        'CO-ANT' => __('Antioquia', 'fluent-cart'),
        'CO-ARA' => __('Arauca', 'fluent-cart'),
        'CO-ATL' => __('Atlántico', 'fluent-cart'),
        'CO-BOL' => _x('Bolívar', 'Colombia Department', 'fluent-cart'),
        ...
        'CO-COR' => _x('Córdoba', 'Colombia Department', 'fluent-cart'),
        ...
        'CO-SUC' => _x('Sucre', 'Colombia Department', 'fluent-cart'),
    ...
    'CR' => array( // Costa Rican states.
        ...
        'CR-SJ' => _x('San José', 'Costa Rica Province', 'fluent-cart'),
    ),
    'CZ' => array(),
    ...
    'DO' => array( // Dominican states.
        ...
        'DO-22' => _x('San Juan', 'Dominican Republic Province', 'fluent-cart'),
    ...
    'EC' => array( // Ecuadorian states.
        ...
        'EC-B' => _x('Bolívar', 'Ecuador Province', 'fluent-cart'),
        ...
        'EC-R' => _x('Los Ríos', 'Ecuador Province', 'fluent-cart'),
    ...
    'ES' => array( // Spanish states.
        ...
        'CO' => _x('Córdoba', 'Spain Province', 'fluent-cart'),
        'CU' => __('Cuenca', 'fluent-cart'),
        'GI' => __('Girona', 'fluent-cart'),
        'GR' => _x('Granada', 'Spain Province', 'fluent-cart'),
        ...
        'LO' => _x('La Rioja', 'Spain Province', 'fluent-cart'),
        'GC' => __('Las Palmas', 'fluent-cart'),
        'LE' => _x('León', 'Spain Province', 'fluent-cart'),
    ...
    'GH' => array( // Ghanaian regions.
        ...
        'CP' => _x('Central', 'Ghanaian Region', 'fluent-cart'),
        'EP' => _x('Eastern', 'Ghanaian Region', 'fluent-cart'),
        'AA' => __('Greater Accra', 'fluent-cart'),
        'NE' => __('North East', 'fluent-cart'),
        'NP' => _x('Northern', 'Ghanaian Region', 'fluent-cart'),
    ...
    'GT' => array( // Guatemalan states.
        ...
        'GT-GU' => _x('Guatemala', 'Guatemala Department', 'fluent-cart'),
    ...
    'HN' => array( // Honduran states.
        ...
        'HN-CL' => _x('Colón', 'Honduras Department', 'fluent-cart'),
        ...
        'HN-LP' => _x('La Paz', 'Honduras Department', 'fluent-cart'),
    ...
    'IN' => array( // Indian states.
        ...
        'PB' => _x('Punjab', 'India State', 'fluent-cart'),
    ...
    'KE' => array( // Kenyan counties.
        ...
        'KE04' => _x('Busia', 'Kenya County', 'fluent-cart'),
    ...
    'LR' => array( // Liberian provinces.
        ...
        'MY' => _x('Maryland', 'Liberia County', 'fluent-cart'),
    ...
    'MD' => array( // Moldovan states.
        ...
        'CL' => _x('Călărași', 'Moldova District', 'fluent-cart'),
    ...
    'NI' => array( // Nicaraguan states.
        ...
        'NI-GR' => _x('Granada', 'Nicaragua Department', 'fluent-cart'),
        'NI-JI' => __('Jinotega', 'fluent-cart'),
        'NI-LE' => _x('León', 'Nicaragua Department', 'fluent-cart'),
    ...
    'PA' => array( // Panamanian states.
        ...
        'PA-3' => _x('Colón', 'Panama Province', 'fluent-cart'),
    ...
    'PE' => array( // Peruvian states.
        ...
        'AMA' => _x('Amazonas', 'Peru Region', 'fluent-cart'),
        ...
        'LAL' => _x('La Libertad', 'Peru Region', 'fluent-cart'),
    ...
    'PK' => array( // Pakistani states.
        ...
        'PB' => _x('Punjab', 'Pakistan Province', 'fluent-cart'),
    ...
    'PY' => array( // Paraguayan states.
        ...
        'PY-8' => _x('Misiones', 'Paraguay Department', 'fluent-cart'),
        'PY-9' => __('Paraguarí', 'fluent-cart'),
        'PY-10' => __('Alto Paraná', 'fluent-cart'),
        'PY-11' => _x('Central', 'Paraguay Department', 'fluent-cart'),
    ...
    'RO' => array( // Romanian states.
        ...
        'CL' => _x('Călărași', 'Romania County', 'fluent-cart'),
    ...
    'SV' => array( // Salvadoran states.
        ...
        'SV-LI' => _x('La Libertad', 'El Salvador Department', 'fluent-cart'),
        'SV-MO' => __('Morazán', 'fluent-cart'),
        'SV-PA' => _x('La Paz', 'El Salvador Department', 'fluent-cart'),
    ...
    'UG' => array( // Ugandan districts.
        ...
        'UG202' => _x('Busia', 'Uganda District', 'fluent-cart'),
    ...
    'US' => array( // U.S. states.
        ...
        'FL' => _x('Florida', 'US State', 'fluent-cart'),
        ...
        'MD' => _x('Maryland', 'US State', 'fluent-cart'),
        ...
        'MT' => _x('Montana', 'US State', 'fluent-cart'),
    ...
    'VE' => array( // Venezuelan states.
        ...
        'VE-F' => _x('Bolívar', 'Venezuela State', 'fluent-cart'),
        ...
        'VE-R' => _x('Sucre', 'Venezuela State', 'fluent-cart'),
        ...
        'VE-Z' => _x('Amazonas', 'Venezuela State', 'fluent-cart'),
    ),
    'VN' => array(),
    'YT' => array(),
    ...
    'ZM' => array( // Zambian provinces.
        ...
        'ZM-02' => _x('Central', 'Zambia Province', 'fluent-cart'),
        'ZM-03' => _x('Eastern', 'Zambia Province', 'fluent-cart'),
        'ZM-04' => __('Luapula', 'fluent-cart'),
        'ZM-05' => _x('Northern', 'Zambia Province', 'fluent-cart'),
